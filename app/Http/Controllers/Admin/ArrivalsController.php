...
class ArrivalsController extends Controller
{
    public function index()
    {
        ...
        return view('admin.arrivals.index', compact('items'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.arrivals.index')->with('success', 'Arrival added successfully.');
    }
    ...
    public function edit($arrival)
    {
        ...
        return view('admin.arrivals.edit', compact('item'));
    }
    ...
    public function update(Request $request, $arrival)
    {
        ...
        return redirect()->route('admin.arrivals.index')->with('success', 'Arrival updated.');
    }
