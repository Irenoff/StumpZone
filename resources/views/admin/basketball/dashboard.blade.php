...
<div class="min-h-screen px-4 py-8 mx-auto bg-gradient-to-br from-orange-50 via-blue-50 to-yellow-50">
    ...
    <div id="addForm" class="hidden transition-all duration-300 ease-in-out transform">
        <div class="p-8 mb-10 border-2 border-orange-200 shadow-xl bg-gradient-to-br from-white to-orange-50 rounded-2xl">
            <form action="{{ route('admin.basketball.store') }}" method="POST" enctype="multipart/form-data" id="itemForm">
                @csrf
                <h2 class="mb-6 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-blue-600">
                    🏀 Add New Basketball Equipment
                </h2>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-orange-500">Enter the product name (3-100 characters)</p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-orange-500">Enter a valid price greater than 0</p>
                    </div>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="flex flex-col items-start space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-xs text-orange-500">JPEG, PNG or GIF (Max 2MB)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2 md:col-span-3">
                        ...
                        <p class="text-xs text-orange-500">Minimum 10 characters, maximum 500 characters</p>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="size" 
                            ...
                            <option value="6">Size 6 (Ball)</option>
                            <option value="7">Size 7 (Ball)</option>
                        </select>
                    </div>
    ...
    <div class="p-6 bg-white shadow-xl rounded-2xl">
        @if($items->isEmpty())
            ...
            <div class="py-20 text-center bg-gradient-to-br from-orange-50 to-blue-50 rounded-xl animate-fade-in">
                ...
                <h3 class="mb-3 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-blue-600">Your Basketball Inventory is Empty</h3>
                <p class="max-w-md mx-auto text-lg text-gray-600">Start building your basketball equipment collection by adding your first item.</p>
                    ...
                    <tbody class="text-sm text-gray-700 divide-y-2 divide-orange-50" id="inventoryTableBody">
                        ...
                        <tr class="transition hover:bg-gradient-to-r hover:from-orange-50 hover:to-blue-50" 
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <img src="{{ $item->image_url }}" 
                                         ...
                                         onclick="showImageModal('{{ $item->image_url }}', '{{ $item->name }}')">
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 space-x-2 text-right">
                                <a href="{{ route('admin.basketball.edit', $item->id) }}" 
                                ...
                                <form action="{{ route('admin.basketball.destroy', $item->id) }}" method="POST" class="inline-block">
                                    @csrf
                                    @method('DELETE')
