...
<body class="relative flex items-center justify-center min-h-screen px-4 overflow-hidden font-sans antialiased bg-gray-900">
    ...
    <div class="w-full max-w-2xl px-6 mx-auto mb-12 side-text-container md:mb-0 md:px-0 md:ml-28">
        <div class="mb-6 text-4xl leading-tight gradient-big-text md:text-6xl drop-shadow-lg">
            Unleash Your Potential
        </div>
        
        <div class="mb-6 text-xl leading-snug gradient-big-text md:text-3xl drop-shadow-lg">
            Every Sport. Every Champion.
        </div>
        
        <div class="mt-4 mb-4 text-lg font-bold leading-relaxed text-transparent bg-gradient-to-r from-amber-400 via-purple-300 to-green-500 bg-clip-text md:text-xl font-display drop-shadow-lg">
    ...
    <div class="relative z-10 w-[550px] p-8 ml-80 transition-all duration-500 transform border shadow-xl bg-gradient-to-br from-gray-800/90 via-gray-900/90 to-gray-800/90 backdrop-blur-lg rounded-xl hover:shadow-2xl hover:shadow-accent-500/30 border-gray-700/50 hover:-translate-y-1 group">
        ...
        <div class="flex flex-col items-center mb-6">
            ...
            <h1 class="mt-4 mb-1 text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-accent-400 via-primary-400 to-accent-400 animate-text-gradient">
                StumpZone
            </h1>
        ...
        <!-- Tagline with animated flicker -->
        <div class="px-4 py-3 mb-6 text-center border rounded-lg bg-gray-800/50 border-gray-700/50 backdrop-blur-sm animate-flicker">
            <p class="text-sm font-medium text-accent-300">
                ⚡ Log into StumpZone to browse the best sports gear and connect with players worldwide!
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="relative z-50 flex items-center justify-between mt-4 text-sm">
                <!-- Remember Me -->
                <label for="remember" class="inline-flex items-center gap-2 text-gray-400 transition-colors cursor-pointer hover:text-gray-300">
                    <input id="remember" name="remember" type="checkbox"
                        class="w-4 h-4 border-gray-700 rounded bg-gray-800/50 text-accent-500 focus:ring-accent-500 focus:border-accent-500" />
                    Remember me
                </label>
                ...
                @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}"
                        class="flex items-center font-medium transition-colors duration-300 text-primary-400 hover:text-primary-300 hover:underline">
        ...
        <p class="relative z-50 mt-8 text-sm text-center text-gray-500">
            Don't have an account?
            <a href="{{ route('register') }}"
               class="relative z-50 font-medium transition-colors duration-300 text-primary-400 hover:text-primary-300 hover:underline">
                Register here
            </a>
        </p>
    </div>
