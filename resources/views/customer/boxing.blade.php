...
@section('content')
    ...
    <div class="relative z-10">
        ...
        <div class="mb-12 text-center">
            <h2 class="mb-3 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-500 md:text-5xl animate-fade-in-down">
                <i class="mr-2 fas fa-football-ball"></i>
                Football Equipment
            </h2>
            <p class="text-lg text-blue-300 animate-fade-in-up">Professional gear for football champions</p>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            @foreach ($items as $item)
                <div class="flex flex-col h-full overflow-hidden transition-all duration-500 transform bg-gray-800 border border-gray-700 shadow-xl rounded-xl hover:shadow-2xl hover:-translate-y-3 group backdrop-blur-sm bg-opacity-70 hover:border-blue-500">
                    ...
                    <div class="relative overflow-hidden cursor-pointer" onclick="showProductDetails({{ json_encode([
                        ...
                        <span class="absolute top-3 right-3 px-3 py-1 text-xs font-bold text-white rounded-full shadow-lg 
                                    @if($item->status === 'available') bg-gradient-to-r from-blue-500 to-cyan-600
                    ...
                    <div class="flex flex-col flex-grow p-6">
                        ...
                        <div class="pt-4 mt-auto">
                            @if($item->status === 'available' && $item->quantity > 0)
                                @if($item->in_cart)
                                    <div class="w-full px-6 py-3 text-center text-white bg-blue-600 rounded-xl">
    ...
    <script>
        ...
        // Product details modal functions (same as cricket page)
        function showProductDetails(item) {
            ...
            if (item.status === 'pre_order') {
                ...
                modalStock.className = 'px-3 py-1 text-sm font-bold text-white rounded-full shadow-lg bg-gradient-to-r from-blue-500 to-cyan-600';
                ...
                if (item.in_cart) {
                    cartButtonContainer.innerHTML = `
                        <div class="px-6 py-2 text-white bg-blue-600 rounded-lg">
                            <span class="flex items-center">
                                <i class="mr-2 fas fa-check-circle"></i>
                                Already in Cart
                            </span>
